...
L1 keeps K persistent experts plus R exchange slots and a bounded pinned P
  elevator. The v0.1.5 DeepSeek4 path can also roll its architecture-specific
...
They are not v0.1.5 throughput claims. v0.1.5 keeps the broader model qualification
...
For v0.1.5, see the [release notes](docs/releases/v0.1.5.md); the broader
