...
$expected = [ordered]@{
    ...
    patchSha256 = '652C5C6E799FC9222C573D5F103E50BD0067E0A12EA4BC52F819CD1FC546A187'
    patchGitBlob = 'b30f4ff72e8b01c871e83636a67c9a829660b9d1'
    patchInsertions = 10449
    patchDeletions = 24
}
...
$expectedFiles = @(
    New-ExpectedEngineFile 'common/arg.cpp' '86af0ba10a327283f2500f0bb8e48095df547017' '21881e865fd7f870b4f25c0cbeeb7b1e707df7dc' '0ca0e05206dc0fbef21e810c63c06b7383cb297d'
    ...
    New-ExpectedEngineFile 'common/common.h' '3444aa157e9b73727ea2ca6107eb0dc9f9b36a74' '86bbf4a9c35e7abc35e0cd1521a6557d41602ca9' '45e60ea73bd563ac658e7a88df5b3f75e754a4de'
    ...
    New-ExpectedEngineFile 'ggml/include/ggml-cuda.h' '1cd81eeaebcdf4abcd46c87ba1a9a46e275aa12b' '9377ba5b12d4ce22025852ecef7b5f15b3cab6cc'
    ...
    New-ExpectedEngineFile 'ggml/src/ggml-cpu/ggml-cpu.c' '491316f7491252248d6f74a60440d3efa7aa6177' 'e09fa142ae1a1c188a34bcf420606383fb9921b8'
    ...
    New-ExpectedEngineFile 'ggml/src/ggml-cpu/siliangem_moe_cache.h' $null 'f0d97e499332959d836ec8d97aa4f63f13b5629d'
    New-ExpectedEngineFile 'ggml/src/ggml-cuda/ggml-cuda.cu' '561ab7ac599f9e285d2a0296caee0ab0a14ea5c8' 'd3d2cb63b8ec6a9e9621d29a44af510b607423ca'
    ...
    New-ExpectedEngineFile 'src/llama-model-loader.cpp' 'b31e92e2da7ef42eabbb47173bb1f2088c952f39' '709db618f656f22e02fbcea1101db185341a8afb'
    New-ExpectedEngineFile 'src/llama-model-loader.h' 'd6b31c2311186608f48e88d1a37c23adc7e1b0c7' 'aa1772d1377724450c2f3b9b3013e771607f8c3f'
    ...
    New-ExpectedEngineFile 'src/siliang-ds4-front-slab.cpp' $null '8068e77bc74bc1198b79c80deb50431551a03c32' '35ad425cc24f181969aee089a65a37f54a1f6122'
    ...
    New-ExpectedEngineFile 'src/siliang-moe-runtime.cpp' $null 'c4acde9e88b47e43238bd50e7db371591050c40e'
