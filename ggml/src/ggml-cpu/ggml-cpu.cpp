...
int ggml_backend_cpu_siliangem_store_cached_expert_at_slot(
    ...
    auto * ctx = (ggml_backend_cpu_context *) backend_cpu->context;
    return ggml_siliangem_cache_state_store_cached_expert_at_slot(
            ctx->siliangem_cache, layer, expert, slot, parts, part_sizes, part_count);
}
...
static void * ggml_backend_cpu_get_proc_address(ggml_backend_reg_t reg, const char * name) {
    ...
    if (strcmp(name, "ggml_backend_cpu_siliangem_store_cached_expert_at_slot") == 0) {
        return (void *)ggml_backend_cpu_siliangem_store_cached_expert_at_slot;
    }
